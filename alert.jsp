...
<%@page import="com.oreilly.servlet.*,java.sql.*,java.lang.*,classes.databaseconnection.*,java.text.SimpleDateFormat,java.util.*,java.io.*,javax.servlet.*, javax.servlet.http.*"  errorPage="Error.jsp"%>
	...
	<div id="menu-wrapper">
		<div id="menu">
			...
			<li ><a href="#"></a></li>
				...
				<li class="current_page_item" ><a href="">FileAlert</a></li>
...
<div id="wrapper">
	...
	%>
			...
			<td><img src="images/alert.png" height="200" width="200" align="right"></td>
...
String f="at";
String c="to";
String d="change the file";
			try
			{
			con=databasecon.getconnection();
			ps=con.prepareStatement("select * from alert ");
			rs=ps.executeQuery();
			while(rs.next())
			{
			id=rs.getString("id");
