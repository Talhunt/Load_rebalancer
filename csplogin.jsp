...
<div id="wrapper">
	...
	<!-- end #header -->
			...
			<form name="form1" action="cspcheck.jsp" method="post">
			<table align="center" bgcolor="#669999" width="300" height="200">
			
			<tr><td><font color="#FFFFFF" face="Geneva, Arial, Helvetica, sans-serif"><strong>Username</strong></font></td><td><input type="text" name="username"></td></tr>
			...
			<tr><td><input type="submit" value="Signin" class="sub6"></td><td><input type="reset" value="Clear" class="sub6"></td></tr>
