...
<div id="wrapper">
	...
	<!-- end #header -->
		...
		<form name="form" action="" method="post" onsubmit="return validation()">
            ...
            <TH><div align="center"><font color="#669999"  size="+1" face="Times New Roman, Times, serif">FILENAME</font> 
              </div></TH>
...
<tr> 
            ...
            <td><div align="center"><font  color="#FFFFFF"  size="+1" face="Times New Roman, Times, serif" > 
                <%=fkey%> </font></div></td>
            <td><div align="center"> 
                <a href="filedownload2.jsp?<%=id%>"><font  color="#FFFFFF"  size="+1" face="Times New Roman, Times, serif" >DOWNLOAD </font></a></div></td>
          </tr>
		   <%
