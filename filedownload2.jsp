...
<%@page import="java.java.classes.ende.*"%>
...
String fkey=null;
	...
	%>
			...
			<th><font color="#669999">Welcome:</font><font color="#FFFFFF" face="Geneva, Arial, Helvetica, sans-serif"><strong>ttp</strong></font></th>
...
%>
			...
			<td><a href="filedownload4.jsp?<%=id%>"><font color="#CC3300" face="Geneva, Arial, Helvetica, sans-serif"><strong>DECRYPT</strong></font></a></td>
            </tr>
				 <%		  
}
%>
